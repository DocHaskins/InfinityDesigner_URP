...
{"woman_zmb_skeleton", "Biter"},{"man_srv_skinybiter_skeleton", "Biter"}
    ...
    private void InitializeDictionaries()
    {
        filters = new Dictionary<string, List<string>>()
        {
            ...
            {"hat", new List<string> {"hat", "cap", "headwear", "beret", "anubis_headwear", "bracken_bandage", "beanie", "sh_man_pk_headcover_c", "headband", "man_bdt_headcover_i", "coverlet"}},
            {"hat_access", new List<string> {"hat", "cap", "headwear", "anubis_headwear", "horns", "beret", "bracken_bandage", "beanie", "hood", "sh_man_pk_headcover_c", "headband", "man_bdt_headcover_i", "coverlet"}},
            ...
            {"torso", new List<string> {"torso", "npc_anderson", "zmb_torso_d_coverlet", "player_reload_outfit", "singer_top", "npc_frank", "bolter", "goon", "charger_body", "corruptor", "screamer", "spitter", "viral_body_torso", "volatile", "zmb_suicider_corpse"}},
            ...
            {"infection", new List<string> { "blisters", "blister", "guts", "destroyed", "horns"}},
            {"infection_2", new List<string> { "blisters", "blister", "guts", "destroyed", "horns"}},
            {"infection_3", new List<string> { "blisters", "blister", "guts", "destroyed", "horns"}},
            {"infection_4", new List<string> { "blisters", "blister", "guts", "destroyed", "horns"}},
        ...
        exclude_filters = new Dictionary<string, List<string>>()
        {
            ...
            {"torso_2", new List<string> {"armor", "sleeve", "plates", "wrench", "detail", "bracer", "bracers", "sh_npc_anderson", "sh_wmn_viral_tier3_b", "bottom", "base", "torso_c_sweater", "stethoscope", "plaguewitch", "horns", "wpntmp", "equipment", "head", "hair", "shoulderpad", "player_camo_torso_a_tpp", "hat", "mask", "player_inquisitor_torso_a_tpp", "player_torso_tpp_a", "addon", "machete_tpp", "skull", "chain_armour", "hands", "battery", "arms", "cape", "turtleneck", "apron", "pants", "backpack", "bag", "parachute", "suspenders", "legs", "hood", "spikes", "chain", "decal", "collar", "scarf", "pouch", "zipper", "belt", "part", "patch", "bag", "pocket", "jewelry", "necklace", "ring"}},
            ...
            {"lhand", new List<string> {"_right", "upper", "headwear", "rag", "belts", "wrapper", "bracer", "bracers", "chains", "elbow", "balaclava", "shoes", "sleeve", "armor", "glove", "decal_tattoo", "tattoo", "torso", "leg", "legs", "pants", "decal"}},
            {"rhand", new List<string> {"_left", "upper", "headwear", "rag", "belts", "wrapper", "bracer", "bracers", "chains", "elbow", "balaclava", "shoes", "sleeve", "armor", "glove", "decal_tattoo", "tattoo", "torso", "leg", "legs", "pants", "decal"}},
            ...
            {"armor_torso_2", new List<string> {"legs", "pants", "bottom", "armor_b_head", "pouches", "walkietalkie", "pin", "leg", "upper", "element", "bottom_a_armor", "cape", "addon", "upperleft", "lowerright", "lowerleft", "upperright"}},
            {"armor_torso_access", new List<string> {"legs", "pants", "mask", "scarf", "hair", "pouches", "pin", "leg", "upper", "cape", "upperleft", "lowerright", "lowerleft", "upperright"}},
            {"armor_torso_extra", new List<string> {"legs", "pants", "mask", "scarf", "hair", "pouches",  "leg", "upper", "cape", "upperleft", "lowerright", "lowerleft", "upperright"}},
            {"armor_torso_upperright", new List<string> {"legs", "pants", "leg", "left"}},
            {"armor_torso_upperleft", new List<string> {"legs", "pants", "leg", "right"}},
            {"armor_torso_lowerright", new List<string> {"legs", "pants", "leg", "left"}},
            {"armor_torso_lowerleft", new List<string> {"legs", "pants", "leg", "right"}},
            {"armor_legs", new List<string> {"mask"}},
            {"armor_legs_access", new List<string> {"mask"}},
            {"armor_legs_upperright", new List<string> { "lowerleft", "lowerright", "upperleft", "arm_", "arms", "left"}},
            {"armor_legs_upperleft", new List<string> { "lowerleft", "lowerright", "upperright", "mask", "arm_", "arms", "right" }},
            {"armor_legs_lowerright", new List<string> { "lowerleft", "upperright", "upperleft", "mask", "arm_", "arms", "left" }},
            {"armor_legs_lowerleft", new List<string> { "upperright", "lowerright", "upperleft", "mask", "arm_", "arms", "right" }}
        };
    }
